...
{
    if (ha.isOpen() and ((uwave.puwve.isPTMode != 1)))
    {
        int nameModem = 1;
    ...
    if ((uwave.puwve.isPTMode == 1))
    {
        ...
        ha.waitForBytesWritten();
        if ((uwave.puwv0.errCode == 0) and (uwave.puwv0.cmdID ==1))
        {
            qDebug()<<"cmd1 sended!";
            emit initCmd1Done();
        }
...
//    qDebug()<<"bytes written :" << ha.write(PUWV2, 18);
    QByteArray array = request_PUWV2(2, 1); //tx = 2 - аппарат, rx = 1 - берег
...
void Hydroacoustics::hudroButtonRYB()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonRBY()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonBRY()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonBYR()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonYBR()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonYRB()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::hudroButtonHHH()
{
    if (ha.isOpen())
    {
        //        qDebug() << "snsn";
...
void Hydroacoustics::indGood()
{

}

void Hydroacoustics::indBed()
{
